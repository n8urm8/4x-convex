...
export const structuresSeedData: StructureDefinitionSeed[] = [
  // Habitat Structures
  {
    ...
    baseEnergyCost: 2,
    baseNovaCost: 300,
    researchRequirementName: 'Basic Habitation',
    effects: '=+10 Space',
  ...
  // Research Structures
  {
    ...
    baseEnergyCost: 4,
    baseNovaCost: 400,
    researchRequirementName: 'Scientific Method',
    effects: '=+5 Research',
  ...
  // Economic Structures
  {
    ...
    baseEnergyCost: 2,
    baseNovaCost: 300,
    researchRequirementName: 'Interplanetary Commerce',
  ...
  // Utility Structures
  {
    ...
    baseNovaCost: 400,
    researchRequirementName: 'Energy Systems',
    effects: '=+10 Energy',
