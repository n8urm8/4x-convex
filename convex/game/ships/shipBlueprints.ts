...
export const shipBlueprintsData: ShipBlueprint[] = [
  // Exploration Ships
  {
    ...
    requiredTechnology: "Kinetic Weapons",
    weaponType: "Kinetic",
    damage: 5,
    defense: 10,
    shielding: 0,
  ...
  },
  {
    ...
    requiredTechnology: "Chemical Propulsion",
    weaponType: "None",
    damage: 0,
    defense: 50,
    shielding: 20,
  ...
  },
  {
    ...
    buildTimeCycles: 3,
    requiredStructure: "Shipyard",
    requiredTechnology: "Energy Weapons",
    weaponType: "Energy",
    damage: 25,
    defense: 10,
    shielding: 5,
  ...
  },
  {
    ...
    buildTimeCycles: 5,
    requiredStructure: "Advanced Shipyard",
    requiredTechnology: "Plasma Weapons",
  ...
  },
  {
    ...
    buildTimeCycles: 8,
    requiredStructure: "Shipyard",
    requiredTechnology: "Advanced Kinetics",
    weaponType: "Kinetic",
    damage: 40,
    defense: 50,
    shielding: 20,
  ...
  // Heavy Combat Ships
  {
    ...
    buildTimeCycles: 50,
    requiredStructure: "Capital Shipyard",
    requiredTechnology: "Capital Ship Design",
    weaponType: "Kinetic",
    damage: 180,
    defense: 150,
    shielding: 100,
  ...
  },
  {
    ...
    requiredTechnology: "Quantum Weapons",
    weaponType: "Plasma",
    damage: 300,
    defense: 250,
    shielding: 200,
  ...
  // Specialized Ships
  {
    ...
    buildTimeCycles: 20,
    requiredStructure: "Advanced Shipyard",
    requiredTechnology: "Ion Propulsion",
    weaponType: "Energy",
    damage: 20,
    defense: 60,
    shielding: 30,
